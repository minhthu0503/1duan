                ...
                <div class="fromBx">
                    ...
                    <div class="form signupForm">
                        <form action="" method="POST">
                            ...
                            <button name="btn" class="signupForm_btn" type="submit">Đăng ký</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="header">
            ...
            <div class="header_right">
                <div class="header_login-logout">
                    <form action="index.php?controller=thanh-vien&action=add">
                ...
                <div class="row">
                    ...
                    <div class="col l-8 l-o-2">
                        <ul class="header_menu-list">
                            ...
                            <li class="header_menu-item">
                                <a href="./products.php" class="header_menu-link">Sản phẩm</a>
                            </li>
                            <li class="header_menu-item">

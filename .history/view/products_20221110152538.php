                        ...
                        <div class="products_banner">
                            <div class="row">
                                <div class="col l-6 c-12 m-12">
                                    <img src="https://www.milem.vn/fileserver/images/file/fixsize-980x460/upload/sitemap/san-pham.png.webp?v=1.3"
                                        alt="" class="products_banner-img">
                                </div>
                                <div class="col l-6 c-12 m-12">
                                    ...
                                    <div class="products_list-left">
                                        <div class="products_list-left-click ">
                                            <div class="products_list-left-header js_left-click1">
                                                ...
                                                <i
                                                    class="products_list-left-i js_left-rotate1 fa-solid fa-caret-right"></i>
                                            </div>
                                    ...
                                    <div class="products_list-left">
                                        <div class="products_list-left-click">
                                            <div class="products_list-left-header js_left-click2">
                                                ...
                                                <i
                                                    class="products_list-left-i js_left-rotate2 fa-solid fa-caret-right"></i>
                                            </div>
                                    ...
                                    <div class="products_list-left">
                                        <div class="products_list-left-click">
                                            <div class="products_list-left-header js_left-click3">
                                                ...
                                                <i
                                                    class="products_list-left-i js_left-rotate3 fa-solid fa-caret-right"></i>
                                            </div>
                                    ...
                                    <div class="products_list-left">
                                        <div class="products_list-left-click">
                                            <div class="products_list-left-header js_left-click4">
                                                ...
                                                <i
                                                    class="products_list-left-i js_left-rotate4 fa-solid fa-caret-right"></i>
                                            </div>
                                    ...
                                    <div class="products_content">
                                        <div class="products_content-list-top">
                                            <div class="row">
                                                ...
                                                <div class="col l-2 c-6 m-4">
                                                    <a href="#" class="products_content-list-top-link">Giá cao<i
                                                            class="fa-solid fa-up-long"></i></a>
                                                </div>
                                                <div class="col l-2 c-6 m-4">
                                                    <a href="#" class="products_content-list-top-link">Giá thấp<i
                                        ...
                                        <div class="slick__item col l-4 c-6 m-6 ">
                                            <div class="slick__item-content"
                                                ...
                                                <h2 class="slick__item-heading"><a class="slick__item-link"
                                                        href="./products_detail.html"> SK-II Skin
                                            ...
                                            <div class="col l-12">
                                                <ul class="products_content-bottom-list">
                                                    <li class="products_content-bottom-item">
                                                        <a href="#" class="products_content-bottom-link i"><i

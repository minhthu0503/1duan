            ...
            <div class="header_right">
                <?php if(isset($_SESSION['username'])){ ?>
                    <div class="header_login-logout">
                            <a href="index.php?controller=users&action=logout" class="header_logout">Đăng xuất</a> <br>
                            <a href="index.php?controller=users&action=logout" class="header_logout">Cập nhật tài khoản</a>
                        </div>
                    <?php } else{?>
                        <div class="header_login-logout">

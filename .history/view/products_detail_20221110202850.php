                ...
                <div class="grid wide">
                    ...
                    <div class="section_new-products-header">
                        <h1 class="section_new-products-heading">Sản phẩm tương tự
                            <a href="index.php?page_layout=products&id_category=<?php echo $data['category_id'] ?>" class="products_detail-heading-link"><?php echo $data['name_category'] ?>" class="section_new-products-link">Xem thêm

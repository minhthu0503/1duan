...
function addOpen1() {
    ...
    document.querySelector('.js_left-remove1').style.display = 'flex';
}
...
function addOpen2() {
    ...
    document.querySelector('.js_left-remove2').style.display = 'flex';
...
function addOpen3() {
    ...
    document.querySelector('.js_left-remove3').style.display = 'flex';
...
function addOpen4() {
    ...
    document.querySelector('.js_left-remove4').style.display = 'flex';
}

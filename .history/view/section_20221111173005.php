            ...
            <section class="section">
                ...
                <div class="section_new-products-header">
                    <h1 class="section_new-products-heading">Sản phẩm mới
                        <a href="index.php?page_layout=products" class="section_new-products-link">Xem thêm
                            ...
                            ?>
                                <div class="slick__item col l-3">
                                    <div class="slick__item-content" title="<?php echo $value['name_category'] ?>">
                                        <a class="silck__item-link" href="index.php?page_layout=products_category&controller=products&action=view_category&id_category=<?php echo $value['id'] ?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class="section_news-block break">
                                        <div class="section_news-block-img">
                                            <a href="" class="section_news-block-link">
                                                <img src="https://www.milem.vn/vi-vn/images/resize-700x0/upload/media/M62c8d506529f2/untitled-3.21.jpg?v=1.3" alt="" class="section_news-img">
                                            </a>
                                        </div>
                                ...
                                <div class="col l-6 c-12 m-12">
                                    <div class="section_news-block break">
                                        <div class="section_news-block-img">
                                            <a href="" class="section_news-block-link">
                                                <img src="https://www.milem.vn/vi-vn/images/resize-700x0/upload/media/M61e6513316d74/1986.3.jpg?v=1.3" alt="" class="section_news-img">
                                            </a>
                                        </div>
                                        <h1 class="section_news-heading">
                                            <a class="section_news-block-link" href="">
                                ...
                                <div class="col l-6 c-12 m-12">
                                    <div class="section_news-block">
                                        <div class="section_news-block-img">
                                            <a href="" class="section_news-block-link">
                                                <img src="https://www.milem.vn/vi-vn/images/autosize-700x0/upload/media/M5cbd9c802de11/facialtreatmentessencesummerskin.jpg" alt="" class="section_news-img">
                                            </a>
                                        </div>
                                        <h1 class="section_news-heading">
                                            <a class="section_news-block-link" href="">
                                ...
                                <div class="col l-6 c-12 m-12">
                                    <div class="section_news-block">
                                        <div class="section_news-block-img">
                                            <a href="" class="section_news-block-link">
                                                <img src="https://www.milem.vn/vi-vn/images/resize-700x0/upload/media/M5d286a6653913/nuoc-than-sk-ii-facial-treatment-essence-noi-dia-chinh-hang.png?v=1.3" alt="" class="section_news-img">
                                            </a>
                                        </div>
                                        <h1 class="section_news-heading">
                                            <a class="section_news-block-link" href="">

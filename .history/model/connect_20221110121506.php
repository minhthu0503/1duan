...
function insertData($username,$fullname,$password,$email,$address,$phone,$conn){
    $sql = "INSERT INTO users VALUES (null,'$username','$fullname','$password','$email','$address','$phone')";

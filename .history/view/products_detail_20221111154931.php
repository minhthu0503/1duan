                ...
                <div class="products_detail-fixed-header">
                    <h1 class="products_detail-fixed-heading">
                        ...
                        <p class="products_detail-fixed-heading-category">Thương hiệu:
                            <a href="index.php?page_layout=products&controller=products&action=view_category&id_category=<?php echo $data['category_id'] ?>" class="products_detail-fixed-heading-link"><?php echo $data['name_category'] ?></a>
                                ...
                                <div class="products_detail-info">
                                    <div class="products_detail-header">
                                        ...
                                        <p class="products_detail-heading-category">Thương hiệu
                                            <a href="index.php?page_layout=products&controller=products&action=view_category&id_category=<?php echo $data['category_id'] ?>" class="products_detail-heading-link"><?php echo $data['name_category'] ?></a>
                                        </p>
                                    </div>
                                        ...
                                        <div class="product_detail-description-wrapper">
                                            ...
                                            <form action="" class="product_detail-comment-form">
                                                ...
                                                <div class="product_detail-comment-form-title">
                                                    ...
                                                    <textarea class="product_detail-comment-input-content" id="review-description" name="description" maxlength="400" spellcheck="true"></textarea>
                                                </div>

                                                <button onclick="loginNow()" class="btn btn--primary product_detail-comment-btn">
                                                    GỬI NHẬN XÉT
                                                </button>
                ...
                <div class="grid wide">
                    ...
                    <div class="section_new-products-header">
                        <h1 class="section_new-products-heading">Sản phẩm tương tự
                            <a href="index.php?page_layout=products&controller=products&action=view_category&id_category=<?php echo $data['category_id'] ?>" class="section_new-products-link">Xem thêm

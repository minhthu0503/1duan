            ...
            <div class="header_right">
                <?php if(isset($_SESSION['username'])){ ?>
                    ...
                    <?php } else{?>
                        ...
                        <div class="header_login-logout">
                            <a href="index.php?page_layout=users&controller=users&action=signin" class="header_login">Đăng nhập</a>            
                            <a href="index.php?page_layout=users&controller=users&action=signup" class="header_logout">Đăng ký</a>            
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col l-8 l-o-2">
                        <ul class="header_menu-list">
                            ...
                            <li class="header_menu-item">
                                <a href="index.php?page_layout=products&controller=products&action=view_all" class="header_menu-link">Sản phẩm</a>
                            </li>
                            <li class="header_menu-item">

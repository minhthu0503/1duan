        ...
        <div class="grid header_product-title">
            <div class="grid wide">
                <div class="header_product">
                    ...
                    <span>/</span>
                    <p class="title1"><?php echo $data_product['name_product'] ?></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="products_detail-fixed-header">
                        ...
                        <?php echo $data_product['name_product'] ?>
                            <p class="products_detail-fixed-heading-category">Thương hiệu:
                                ...
                                <span class="products_detail-fixed-price"><?php echo $data_product['price'] ?></span>
                            </p>
                        </h1>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col l-5 m-12 c-12">
                                    ...
                                    <div class="silder_img-products">
                                        ...
                                        <div class="imgBox"><img src="./assets/img/product<?php echo $data_product['image_product'] ?>" alt=""
                                ...
                                <div class="col l-6 l-o-1 c-12 m-12">
                                    ...
                                    <div class="products_detail-info">
                                        ...
                                        <span class="products_detail-price"><?php echo $data_product['price'] ?></span>

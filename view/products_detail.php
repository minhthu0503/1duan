                ...
                <div class="products_detail-fixed-header">
                    <h1 class="products_detail-fixed-heading">
                        ...
                        <p class="products_detail-fixed-heading-category">Thương hiệu:
                            <a href="index.php?page_layout=products_category&controller=products&action=view_category&id_category=<?php echo $data['category_id'] ?>" class="products_detail-fixed-heading-link"><?php echo $data['name_category'] ?></a>
                                ...
                                <div class="products_detail-info">
                                    <div class="products_detail-header">
                                        ...
                                        <p class="products_detail-heading-category">Thương hiệu
                                            <a href="index.php?page_layout=products_category&controller=products&action=view_category&id_category=<?php echo $data['category_id'] ?>" class="products_detail-heading-link"><?php echo $data['name_category'] ?></a>
                                        </p>
                                    </div>

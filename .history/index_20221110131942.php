                            ...
                            <div class="slick__slider row">
                                ...
                                <div class="slick__item col l-3">
                                    <div class="slick__item-content"
                                        ...
                                        <a class="silck__item-link" href="index.php?controller=products_detail&action=">
                                            <img class="slick__item-img" class=""
                                                src="./assets/img/product/<?php echo $value['image_product'] ?>"
                                                alt="">
                                        </a>

                                        <h2 class="slick__item-heading"><a class="slick__item-link" href="index.php?controller=products_detail&action="> <?php echo $value['name_product'] ?></a>
                                        </h2>

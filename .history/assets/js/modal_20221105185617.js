...
const js_left_click1 = document.querySelectorAll('.js_left-click1');
const js_left_show1 = document.querySelectorAll('.js_left-show1');
const js_left_remove1 = document.querySelectorAll('.js_left-remove1');

const js_left_click2 = document.querySelectorAll('.js_left-click2');
const js_left_show2 = document.querySelectorAll('.js_left-show2');
const js_left_remove2 = document.querySelectorAll('.js_left-remove2');
...
js_left_click1.addEventListener('click', addOpen);
js_left_remove1.addEventListener('click', removeOpen);
